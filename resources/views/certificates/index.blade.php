...
<div class="container mx-auto my-12">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('certificates.create') }}" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">Tambah Sertifikat</a>
    </div>
                ...
                @forelse ($certificates as $certificate)
                    <tr class="hover:bg-gray-100 transition-all duration-300">
                        ...
                        <td class="px-6 py-4 text-sm flex justify-center space-x-4">
                            <a href="{{ route('certificates.show', $certificate->id) }}" class="px-4 py-2 bg-green-500 text-white rounded-lg shadow-lg hover:shadow-xl hover:bg-green-600 transform hover:scale-105 transition-all">Detail</a>
                            <a href="{{ route('certificates.edit', $certificate->id) }}" class="px-4 py-2 bg-yellow-500 text-white rounded-lg shadow-lg hover:shadow-xl hover:bg-yellow-600 transform hover:scale-105 transition-all">Edit</a>
