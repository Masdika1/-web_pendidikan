...
<div class="container mx-auto p-6">
    ...
    @if (session('success'))
        <div class="bg-green-100 border border-green-400 text-green-700 p-4 rounded-lg mb-6 flex items-center shadow-md">
            <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7 21h10a2 2 0 002-2V7a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
    ...
    <div class="flex justify-end mb-6">
        <a href="{{ route('reviews.create') }}"
           class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-200 ease-in-out">
        ...
        @forelse ($reviews as $review)
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform hover:scale-105 transition duration-200 ease-in-out">
                <div class="p-6">
                    ...
                    <!-- Actions (Hanya jika student adalah pembuat review) -->
