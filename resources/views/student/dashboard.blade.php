...
<div class="mt-10">
    <div class="swiper mySwiper rounded-lg overflow-hidden shadow-lg" style="max-height: 300px;">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="https://i.pinimg.com/236x/de/be/94/debe949ec68921fe947d5909c0541ac3.jpg" alt="Slide 3" class="w-full h-full object-cover rounded-lg bg-gray-200">
            </div>
        </div>
...
<div class="mt-12 grid gap-8 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
    <a href="{{ route('student.kursusku.index') }}" class="relative bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 flex items-center justify-between cursor-pointer">
        <div>
            <p class="text-sm text-gray-600">Kursus Saya</p>
            <h4 class="text-2xl font-bold text-gray-800 mt-2"></h4>
        </div>
    ...
    <a href="{{ route('student.kursuses.index') }}" class="relative bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 flex items-center justify-between cursor-pointer">
        <div>
    ...
    <a href="{{ route('student.sertifikat.index') }}" class="relative bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 flex items-center justify-between cursor-pointer">
        <div>
